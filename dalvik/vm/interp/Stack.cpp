    ...
    bool fromJni, JValue* pResult, va_list args)
{
    ...
    //=========================detection start=========================//
    if (pkg_id == (int) getuid() && strcmp(enable_java_method_trace, "true") == 0) {
        int comIncluded = strncmp(clazz->descriptor, "Lcom", 4);
        if (!fromJni && comIncluded == 0) {
            char* signature = dexProtoCopyMethodDescriptor(&method->prototype);
            ALOGI("analysisLog - Java trace - dvmCallMethodV - { method: %s, signature: %s, in class: %s }", method->name, signature, clazz->descriptor);
        }
    }
    //=========================detection end=========================//
    ...
    bool fromJni, JValue* pResult, const jvalue* args)
{
    ...
    if (pkg_id == (int) getuid() && strcmp(enable_java_method_trace, "true") == 0) {
        ...
        if (!fromJni && comIncluded == 0) {
            char* signature = dexProtoCopyMethodDescriptor(&method->prototype);
            ALOGI("analysisLog - Java trace - dvmCallMethodA - { method: %s, signature: %s, in class: %s }", method->name, signature, clazz->descriptor);
        }
    }
    //=========================detection end=========================//
    ...
    bool noAccessCheck)
{
    //=========================detection start=========================//
    if (pkg_id == (int) getuid() && strcmp(enable_java_method_trace, "true") == 0) {
        int comIncluded = strncmp(method->clazz->descriptor, "Lcom", 4);
        if (comIncluded == 0) {
            char* signature = dexProtoCopyMethodDescriptor(&method->prototype);
            ALOGI("analysisLog - Java trace - dvmInvokeMethod - { method: %s, signature: %s, in class: %s }", method->name, signature, method->clazz->descriptor);
        }
    }
    //=========================detection end=========================//
